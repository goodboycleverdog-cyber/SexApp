...
let types=["anal", "vaginal","vaginal","vaginal","vaginal","vaginal"]; 
...
function txtInfo() {
    ...
    document.write('<script src="nextNextcopy.js"></script>');
    ...
    document.write('<button type="button" class="btn btn-light btn-lg btn-block"><a href="index2.html" target="_blank">La deuxième suite...</a></button>');
